...
def parsearg():
    ...
    parser.add_argument('--filename', default='bayes_90-12-4-q.cnf', type=str, help='Name of the file')
    ...
    parser.add_argument('--sample_size', type=int, default=50000, help='Sampled data size')
